...
// UploadObject provides a mock function with given fields: name, bucket, obj, public
func (_m *MockGCS) UploadObject(name string, bucket string, obj []byte, public bool) error {
	ret := _m.Called(name, bucket, obj, public)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, []byte, bool) error); ok {
		r0 = rf(name, bucket, obj, public)
	} else {
		r0 = ret.Error(0)
	}
